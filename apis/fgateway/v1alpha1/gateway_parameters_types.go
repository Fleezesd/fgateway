...
// +kubebuilder:rbac:groups=fgateway.fleezesd.io,resources=gatewayparameters,verbs=get;list;watch
// +kubebuilder:rbac:groups=fgateway.fleezesd.io,resources=gatewayparameters/status,verbs=get;update;patch
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// A GatewayParameters contains configuration that is used to dynamically
// provision fgateway's data plane (Envoy proxy instance), based on a
// Kubernetes Gateway.
//
// +genclient
// +kubebuilder:object:root=true
// +kubebuilder:metadata:labels={app=fgateway,app.kubernetes.io/name=fgateway}
// +kubebuilder:resource:categories=fgateway,shortName=fgw
