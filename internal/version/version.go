...
var (
	// UndefinedVersion is the version of the fgateway controller
	// if the version is not set.
	UndefinedVersion = "undefined"

	// Version is the version of the fgateway controller.
	// This is set by the linker during build.
	Version string

	// ref is the version of the fgateway controller.
