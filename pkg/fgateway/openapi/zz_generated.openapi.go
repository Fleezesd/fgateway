...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/fleezesd/fgateway/apis/fgateway/v1alpha1.GatewayParameters": schema_fgateway_apis_fgateway_v1alpha1_GatewayParameters(ref),
...
func schema_fgateway_apis_fgateway_v1alpha1_GatewayParameters(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "A GatewayParameters contains configuration that is used to dynamically provision fgateway's data plane (Envoy proxy instance), based on a Kubernetes Gateway.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/fleezesd/fgateway/apis/fgateway/v1alpha1.GatewayParametersSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/fleezesd/fgateway/apis/fgateway/v1alpha1.GatewayParametersStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/fleezesd/fgateway/apis/fgateway/v1alpha1.GatewayParametersSpec", "github.com/fleezesd/fgateway/apis/fgateway/v1alpha1.GatewayParametersStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
